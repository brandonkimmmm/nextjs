const Nav = () => {
	return (
		<nav className='flex flex-wrap items-center justify-between p-5 bg-blue-200'>      
			...
			<div className='toggle hidden w-full md:w-auto md:flex text-right text-bold mt-5 md:mt-0 border-t-2 border-blue-900 md:border-none'>
				<a href='#' className='block md:inline-block text-blue-900 hover:text-blue-500 px-3 py-3 border-b-2 border-blue-900 md:border-none'>CREATE JOB</a>
				...
				<a href='#' className='tblock md:inline-block text-blue-900 hover:text-blue-500 px-3 py-3 border-b-2 border-blue-900 md:border-none'>LOGOUT</a>
			</div>
		</nav>
	)
}
